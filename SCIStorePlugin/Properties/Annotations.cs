...
namespace SCIStore.Properties
{
  ...
  /// <list>
  /// <item><c>NotifyChanged("IStageArgsStageSpecificArguments")</c></item>
  /// <item><c>NotifyChanged(() =&gt; IStageArgsStageSpecificArguments)</c></item>
  /// <item><c>NotifyChanged((VM x) =&gt; x.IStageArgsStageSpecificArguments)</c></item>
  /// <item><c>SetProperty(ref myField, value, "IStageArgsStageSpecificArguments")</c></item>
  /// </list>
  /// </example>
