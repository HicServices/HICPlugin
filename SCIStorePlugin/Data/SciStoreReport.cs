...
namespace SCIStorePlugin.Data
{
    ...
    public class BadCombinedReportDataException : Exception
    {
        ...
        {
            return "Bad report: " + BadReport.SciStoreRecord.LabNumber + ", " + BadReport.SciStoreRecord.TestReportID + " (" + BadReport.HbExtract + ")";
        }
    }
    ...
    public class SciStoreReportFactory
    {
	    ...
	    {   
	        ...
	        try
	        {
	            ...
	            {
                    listener.OnNotify(this, new NotifyEventArgs(ProgressEventType.Warning, "No samples found in report " + report.Header.LabNumber + "-" + report.Header.TestReportID));
	                return report;
	            }
