...
class NuspecIsCorrectTests
{
    ...
    [TestCase("../../../../DrsPlugin/DrsPlugin.csproj", null, "../../../../Packages.md")]
    [TestCase("../../../../GoDartsPlugin/GoDartsPlugin.csproj", null, "../../../../Packages.md")]
    [TestCase("../../../../GoDartsPluginUI/GoDartsPluginUI.csproj", null, "../../../../Packages.md")]
    [TestCase("../../../../HICPlugin/HICPlugin.csproj", null, "../../../../Packages.md")]
    [TestCase("../../../../HICPluginInteractive/HICPluginInteractive.csproj", null, "../../../../Packages.md")]
    [TestCase("../../../../JiraPlugin/JiraPlugin.csproj", null, "../../../../Packages.md")]
    [TestCase("../../../../SCIStorePlugin/SCIStorePlugin.csproj", null, "../../../../Packages.md")]
    public void TestDependencyCorrect(string csproj, string nuspec, string packagesMarkdown)
    {
        ...
        foreach (Match p in rPackageRef.Matches(File.ReadAllText(csproj)))
        {
            ...
            {
                if (!Regex.IsMatch(line, $@"[\s[]{Regex.Escape(package)}[\s\]]", RegexOptions.IgnoreCase)) continue;
